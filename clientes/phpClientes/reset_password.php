...
if(!empty($_POST)){
    ...
    if(count($errors) == 0){
        ...
        if(actualizaPassword($user_id, $pass_hash, $con)) {
            ...
            $errors[] = "Error al modificar la contraseña. Intetalo de nuevo.";
        }
    }
    ...
    <header>
        <nav class="fondo">
            <ul class="nav nav-underline">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="#" aria-current="page"><span class="badge bg-secondary">Cambiar</span></a>
                </li>
            </ul>
        </nav>  
    </header>
